...
class User(UserMixin, db.Model):
    ...
    blog_posts = db.relationship("BlogPost", back_populates="user", cascade="all, delete")
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            new_user = User(
                email=email,
                name=name,
                hash=generate_password_hash(password, "pbkdf2:sha256:1000", 8)
            )
            ...
            flash('This user already exists. Please try logging in instead.')
